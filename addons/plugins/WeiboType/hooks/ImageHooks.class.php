...
class ImageHooks extends AbstractWeiboTypeHooks
{
    ...
    {
        $html = sprintf("<a href='javascript:void(0)' onclick='weibo.plugin.image.click(this)' class='a52'><img class='icon_add_img_d' src='%s' />图片</a>",$this->htmlPath."/html/images/zw_img.gif");
        echo $html;
    }
